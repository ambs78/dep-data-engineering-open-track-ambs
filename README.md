...
1) GOAT Calculator -  will show all relevant stats, where the user can vary the weight of each stat/KPI and calculate the overall GOAT Rating to see who wins
